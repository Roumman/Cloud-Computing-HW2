# Скрипт автоматизирует установку и настройку nginx в качестве балансировщика нагрузки для двух инстансов Logbroker (10.2.0.20 и 10.2.0.22): устанавливает nginx, создаёт конфигурацию с upstream‑серверами, настраивает проксирование и проверяет корректность конфигурации перед перезапуском сервиса.
